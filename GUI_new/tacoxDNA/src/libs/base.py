...
class Nucleotide():
    ...
    def __init__(self, cm_pos, a1, a3, base, btype=None, v=np.array([0., 0., 0.]), L=np.array([0., 0., 0.]), n3=-1):
        ...
        base = int(base)            #added by Marco Lolaico --> probably, not good lol
...
class Strand():
    ...
    def _get_Marco_output(self):        #get_lorenzo_output modified by Marco Lolaico, only return conf file
        if not self.visible:
            return ""
